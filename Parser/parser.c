// @generated by pegen.py from C:\Users\User\src\cpython\Grammar\python.gram
#include "pegen.h"
...
#define plain_except_block_type 1037
#define star_except_block_type 1038
...
#define _tmp_54_type 1216
#define _loop0_55_type 1217
#define _loop0_56_type 1218
#define _loop0_57_type 1219
#define _loop1_58_type 1220
#define _loop0_59_type 1221
#define _loop1_60_type 1222
#define _loop1_61_type 1223
#define _loop1_62_type 1224
#define _loop0_63_type 1225
#define _loop1_64_type 1226
#define _loop0_65_type 1227
#define _loop1_66_type 1228
#define _loop0_67_type 1229
#define _loop1_68_type 1230
#define _loop1_69_type 1231
#define _tmp_70_type 1232
#define _loop1_71_type 1233
#define _loop0_73_type 1234
#define _gather_72_type 1235
#define _loop1_74_type 1236
#define _loop0_75_type 1237
#define _loop0_76_type 1238
#define _loop0_77_type 1239
#define _loop1_78_type 1240
#define _loop0_79_type 1241
#define _loop1_80_type 1242
#define _loop1_81_type 1243
#define _loop1_82_type 1244
#define _loop0_83_type 1245
#define _loop1_84_type 1246
#define _loop0_85_type 1247
#define _loop1_86_type 1248
#define _loop0_87_type 1249
#define _loop1_88_type 1250
#define _loop1_89_type 1251
#define _loop1_90_type 1252
#define _loop1_91_type 1253
#define _tmp_92_type 1254
#define _loop0_94_type 1255
#define _gather_93_type 1256
#define _tmp_95_type 1257
#define _tmp_96_type 1258
#define _tmp_97_type 1259
#define _tmp_98_type 1260
#define _loop1_99_type 1261
#define _tmp_100_type 1262
#define _tmp_101_type 1263
#define _loop0_103_type 1264
#define _gather_102_type 1265
#define _loop1_104_type 1266
#define _loop0_105_type 1267
#define _loop0_106_type 1268
#define _loop0_108_type 1269
#define _gather_107_type 1270
#define _tmp_109_type 1271
#define _loop0_111_type 1272
#define _gather_110_type 1273
#define _loop0_113_type 1274
#define _gather_112_type 1275
#define _loop0_115_type 1276
#define _gather_114_type 1277
#define _loop0_117_type 1278
#define _gather_116_type 1279
#define _loop0_118_type 1280
#define _loop0_120_type 1281
#define _gather_119_type 1282
...
static excepthandler_ty plain_except_block_rule(Parser *p);
static excepthandler_ty star_except_block_rule(Parser *p);
...
// except_block: plain_except_block | star_except_block
...
except_block_rule(Parser *p)
{
    ...
    { // plain_except_block
        ...
        D(fprintf(stderr, "%*c> except_block[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "plain_except_block"));
        excepthandler_ty plain_except_block_var;
        if (
            (plain_except_block_var = plain_except_block_rule(p))  // plain_except_block
        )
        {
            D(fprintf(stderr, "%*c+ except_block[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "plain_except_block"));
            _res = plain_except_block_var;
            goto done;
        }
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s except_block[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "plain_except_block"));
    }
    { // star_except_block
        if (p->error_indicator) {
            D(p->level--);
        ...
        D(fprintf(stderr, "%*c> except_block[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "star_except_block"));
        excepthandler_ty star_except_block_var;
        if (
            (star_except_block_var = star_except_block_rule(p))  // star_except_block
        )
        {
            D(fprintf(stderr, "%*c+ except_block[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "star_except_block"));
            _res = star_except_block_var;
            goto done;
        }
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s except_block[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "star_except_block"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// plain_except_block: 'except' expression ['as' NAME] ':' block | 'except' ':' block
static excepthandler_ty
plain_except_block_rule(Parser *p)
{
    D(p->level++);
    if (p->error_indicator) {
        D(p->level--);
    ...
    { // 'except' expression ['as' NAME] ':' block
        ...
        D(fprintf(stderr, "%*c> plain_except_block[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "'except' expression ['as' NAME] ':' block"));
        Token * _keyword;
        Token * _literal;
        asdl_stmt_seq* b;
        expr_ty e;
        ...
        {
            D(fprintf(stderr, "%*c+ plain_except_block[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'except' expression ['as' NAME] ':' block"));
            Token *_token = _PyPegen_get_last_nonnwhitespace_token(p);
            if (_token == NULL) {
                D(p->level--);
                return NULL;
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Py_ExceptHandler ( e , ( t ) ? ( ( expr_ty ) t ) -> v . Name . id : NULL , b , 0 , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s plain_except_block[%d-%d]: %s failed!\n", p->level, ' ',
    ...
    { // 'except' ':' block
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Py_ExceptHandler ( NULL , NULL , b , 0 , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
...
//     | 'except' '*' ':' block
static excepthandler_ty
star_except_block_rule(Parser *p)
{
    D(p->level++);
    if (p->error_indicator) {
        D(p->level--);
    ...
    { // 'except' '*' expression ['as' NAME] ':' block
        ...
        D(fprintf(stderr, "%*c> star_except_block[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "'except' '*' expression ['as' NAME] ':' block"));
        Token * _keyword;
        Token * _literal;
        Token * _literal_1;
        asdl_stmt_seq* b;
        ...
        {
            D(fprintf(stderr, "%*c+ star_except_block[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'except' '*' expression ['as' NAME] ':' block"));
            Token *_token = _PyPegen_get_last_nonnwhitespace_token(p);
            if (_token == NULL) {
                D(p->level--);
                return NULL;
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Py_ExceptHandler ( e , ( t ) ? ( ( expr_ty ) t ) -> v . Name . id : NULL , b , 1 , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s star_except_block[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "'except' '*' expression ['as' NAME] ':' block"));
    }
    { // 'except' '*' ':' block
        if (p->error_indicator) {
        ...
        )
        {
            ...
            int _end_col_offset = _token->end_col_offset;
            UNUSED(_end_col_offset); // Only used by EXTRA macro
            _res = _Py_ExceptHandler ( NULL , NULL , b , 1 , EXTRA );
            if (_res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                D(p->level--);
                return NULL;
