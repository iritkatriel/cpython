 ...
 * ian cause a stack overflow. We reduce the maximum depth for all Windows
...
/*[clinic end generated code: output=9a1f2325db169b0d input=e8af2c0e509d2fb7]*/
{
    RFILE rf;
    char *s = bytes->buf;
